 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `➪ ANIME MENU`, rowId: ".? anime", description: "Kamu wibu ya bang?"},
  ...
  {title: `➪ SOUND MENU`, rowId: ".soundmenu", description: "Kumpulan 120 Sound"},
	{title: `➪ GROUP MENU`, rowId: ".? group", description: "Only Groups"},
	...
	{title: `➪ INFO BOT`, rowId: ".? info", description: "Info info BOT"},
...
┊↬✗• *sᴛᴀᴛᴜs:* ${m.sender.split`@`[0] == ownernya ? 'Developer' : (usrs.premiumTime >= 1 ? 'Premium User' : 'Free User')}
